...
class _TrackingLocationState extends State<TrackingLocation> {
  ...
  bool _showOverlayImage = false;
   ...
   Future<void> _fetchAddress() async {
    ...
    try {
      ...
      String address = await locationService.getAddressFromLatLng(widget.lat!, widget.lng!);
      double distance = locationService.calculateDistance(position!.latitude, position!.longitude, widget.lat!, widget.lng!);
 ...
 CircleAvatar(
  ...
  Navigator.push(
    ...
    MaterialPageRoute(
      builder: (context) => LiveTracking(
        currentPersonLat: 40.758896, // Times Square, NY
        currentPersonLng: -73.985130, // Times Square, NY
