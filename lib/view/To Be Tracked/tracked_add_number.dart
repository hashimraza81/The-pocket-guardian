...
class TrackedAddNumber extends StatefulWidget {
  const TrackedAddNumber({super.key});

  @override
  State<TrackedAddNumber> createState() => _TrackedAddNumberState();
}

class _TrackedAddNumberState extends State<TrackedAddNumber> {
  @override
